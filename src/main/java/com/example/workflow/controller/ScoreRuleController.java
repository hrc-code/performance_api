...
import com.example.workflow.model.entity.PositionScoreView;
import com.example.workflow.model.entity.ScoreAssessors;
import com.example.workflow.model.entity.ScoreContactAssessors;
...
import com.example.workflow.model.feedback.PositionScoreError;
import com.example.workflow.model.feedback.ScoreError;
import com.example.workflow.model.pojo.PositionScoreExcel;
import com.example.workflow.model.pojo.ScoreExcel;
...
public class ScoreRuleController {
    ...
    public void uploadPositionExcel(MultipartFile file,HttpServletResponse response) throws IOException {
        ...
        if(!ErrorExcelWrite.getErrorCollection().isEmpty()){
            ...
            EasyExcel.write(response.getOutputStream(), PositionScoreError.class).sheet("错误部分").doWrite(ErrorExcelWrite.getErrorCollection());
        }
        ErrorExcelWrite.clearErrorCollection();
    }
}
